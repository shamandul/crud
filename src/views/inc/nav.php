<nav class="relative px-4 py-4 flex justify-between items-center bg-white">
    ...
    <ul
      ...
      <li>
        <a class="text-sm text-gray-400 hover:text-gray-500" href="#">Inicio</a>
      </li>
      <li class="text-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
          stroke="currentColor" class="w-4 h-4 current-fill"
          viewBox="0 0 24 24">
      ...
      <li>
        <a class="text-sm text-blue-600 font-bold" href="#">Producto</a>
      </li>
      <li class="text-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
          stroke="currentColor" class="w-4 h-4 current-fill"
      ...
      <li>
        <a class="text-sm text-gray-400 hover:text-gray-500" href="#">Precio</a>
      </li>
      <li class="text-gray-300">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none"
          stroke="currentColor" class="w-4 h-4 current-fill"
