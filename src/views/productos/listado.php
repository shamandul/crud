<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
  <div>
    <p class="text-lg">Listado de Productos</p>
  </div>
  <table
    ...
    <?php foreach ($respuesta['listado'] as $item) : ?>
      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
        ...
        <td class="px-6 py-4"><?php echo $item->getImagen(); ?></td>
        <th scope="row"
          class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
          <?php echo $item->getNombre(); ?>
        </th>
        <td class="px-6 py-4"><?php echo $item->getDescripcion(); ?></td>
        <td class="px-6 py-4"><?php echo $item->getPrecio(); ?></td>
        <td class="px-6 py-4"><?php echo $item->getFechaAlta(); ?></td>
        <td class="px-6 py-4"><?php echo $item->getFechaModificacion(); ?></td>
        <td class="px-6 py-4 text-right">
          <a href="/productos/editar/<?php echo $item->getId(); ?>"
            class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Editar</a>
          <a href="/productos/borrar/<?php echo $item->getId(); ?>"
