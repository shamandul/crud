            ...
            <div class="grid gap-4 sm:grid-cols-2 sm:gap-6">
                <div class="sm:col-span-2">
                    ...
                    <input type="text" name="nombre" id="nombre"
                        value="<?php echo isset($respuesta['form']['values']) ? $respuesta['form']['values']->getCategoria() : ''; ?>"
                ...
                <div class="sm:col-span-2">
                    ...
                    <textarea id="descripcion" rows="8" name="descripcion"
                        ...
                        placeholder="Escribe aquí la descripción de la categoría"><?php echo isset($respuesta['form']['values']) ? $respuesta['form']['values']->getDescripcion() : ''; ?></textarea>
                </div>
            </div>
            <button type="submit"
